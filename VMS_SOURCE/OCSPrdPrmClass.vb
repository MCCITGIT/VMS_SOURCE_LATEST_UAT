...
Public Class OCSPrdPrmClass
    ...
    Public Function InsertUpdatePrmPrd(ByVal Entity As OCSPrmPrdEntity, ByVal sqlConn As SqlConnection, ByVal sqlTrans As SqlTransaction) As Integer
        ...
        Try
            ...
            sqlParams(9).Value = Convert.ToDecimal(Entity.Min_Value)
            ...
            sqlParams(10).Value = Convert.ToDecimal(Entity.Max_Value)
    ...
    Public Function GetProductCode(ByVal ProductType As String) As DataSet
