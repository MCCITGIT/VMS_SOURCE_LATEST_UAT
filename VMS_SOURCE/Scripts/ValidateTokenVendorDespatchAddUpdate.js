function ValidateSubmit() {
    firstErrorControl = "";
    errMsg = "";
    ValidateRequired("ddlVendorUnit", "Please select vendor unit.");
    ValidateRequired("ddlVendorRequisition", "Please select vendor requisition.");
    ValidateRequired("txt_transporter", "Please enter  transporter.");
    //ValidateRequired("txt_truck_no", "Please enter truck no.");
    ValidateRequired("txt_vendor_challan_no", "Please enter vendor challan no.");
    ValidateRequired("txtChallanDate", "Please enter challan date.");
    ValidateRequired("txt_road_permit", "Please enter road permit.");
