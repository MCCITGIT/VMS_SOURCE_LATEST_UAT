<%@ Page Title="Unit Despatch Plan Add" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="VendorChallanDetail.aspx.vb" Inherits="VendorChallanDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="breadcrumbs">
        <div class="leftFung">
            ...
            <div class="pageTitleWrap">
                ...
                <p class="pageSubTitle">Create and update vendor despatch challans</p>
            </div>
        </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server">
        <ContentTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlProduct" runat="server" AutoPostBack="True" CssClass="form-control select2" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged"
                                    TabIndex="4">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlAllSku" runat="server" AutoPostBack="True" CssClass="form-control select2"
                                    Style="position: static;" TabIndex="5">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                    <ContentTemplate>
                                        <asp:CheckBox class="checkRadioGroup" ID="chkApprovedTranspoterYN" runat="server" OnCheckedChanged="chkApprovedTranspoterYN_CheckedChanged" AutoPostBack="true" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                        <div class="col-md-3" id="SearchTranspoter" runat="server" visible="false">
                            <div class="form-group">
                                <label class="form-control-label">Search By Transpoter Name/Id:</label>
                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                    <ContentTemplate>
                                        <div class="flexC">
                                            ...
                                            <asp:LinkButton ID="btnResetdealerDetails" runat="server" Text="Reset"><img alt="Reset" src="images/img-reset.JPG" style="visibility: visible; display: inline;" width="16px" /></asp:LinkButton>
                                        </div>
                                        ...
                                        <img alt="Loading..." src="images/ajax-loader.gif" id="loading" style="visibility: hidden; display: none;" width="16px" />
                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="150" Width="550"
                                            Style="overflow-y: scroll; position: absolute; left: 0; top: 0">
                                        </asp:Panel>
                                        <span class="mandatory">* (Enter atleast 3 characters.)</span>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <%--<a href="javascript:cal1.select(document.forms[0].txtCenvatDt,'cenvatDt','dd/MM/yyyy');">
                            ...
                            <div class="form-group">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <%--<a href="javascript:cal1.select(document.forms[0].txtEwayBillDate,'ewayDt','dd/MM/yyyy');">
                            ...
                            <div class="form-group">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <%--<a href="javascript:cal1.select(document.forms[0].txtValidUpto,'validUptoDt','dd/MM/yyyy');">
                        ...
                        <div class="col-md-3" id="uploadID" runat="server" visible="false">
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvSKUDetails" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="This Despatch" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtThisDesp" CssClass="form-control" runat="server" Text='<%# Bind("pendingLoad") %>' TextMode="Number" MaxLength="30" Enabled="False"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="LOT" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtLOT" CssClass="form-control" runat="server" Text='<%# Bind("despd_lot_no") %>' Enabled="False"></asp:TextBox>
                                            </ItemTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-success btn-sm" Text="Submit" Visible="false" />
                                    <asp:Button ID="btnCancel" CssClass="btn btn-secondary btn-sm" runat="server" Text="Cancel" PostBackUrl="~/VendorChallanList.aspx" />
                                </div>
                            </div>
            ...
            <div id="divDespatchQuantity" style="text-align: center; display: none;" runat="server">
