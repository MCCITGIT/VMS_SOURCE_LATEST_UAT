<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TokenVendorRequisitionList.aspx.vb" Inherits="TokenVendorRequisitionList" %>
                    ...
                    <table style="width: 85%;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="height: 15px; width: 100%; text-align: center;">
                                <h2 style="font-size: 14px; font-weight: bold; color: #6694e2; margin: 0px; font-family: Verdana; text-decoration: underline;">Token Requisition List (Vendor)</h2>
                                            ...
                                            <table style="width: 100%; text-align: center;" class="mt">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:TextBox ID="txtFromDate" CssClass="txtBox" Style="cursor: not-allowed" runat="server" ReadOnly="true" Width="90px" MaxLength="10"></asp:TextBox>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:TextBox ID="txtTodate" CssClass="txtBox" Style="cursor: not-allowed" runat="server" ReadOnly="true" Width="90px" MaxLength="10"></asp:TextBox>
