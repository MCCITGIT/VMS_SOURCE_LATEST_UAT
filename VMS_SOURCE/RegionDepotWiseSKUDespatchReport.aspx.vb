...
Partial Class RegionDepotWiseSKUDespatchReport
...
#End Region
    ...
    Protected Sub btndownload_Click(sender As Object, e As EventArgs)
        Try
            ...
            ExcelSet = reportObj.GetRegionDepotWiseSKUDespatchReport(ddlProcessYr.SelectedValue, ddlProcessMnth.SelectedValue, userInfo.userIDEntity, ddlproductcat.SelectedValue, ddlproductcode.SelectedValue, ddlRegion.SelectedValue, ddlDepot.SelectedValue, ddlUnit.SelectedValue)
    ...
    Private Sub ExportToExcelSheet(ByVal ds As DataSet)
        ...
        Dim fs As FileStream = New FileStream(Server.MapPath(Request.ApplicationPath) & "\Templates\Region_Depot_Wise_Unit_Despatch_Report_Template.xlsx", FileMode.Open, FileAccess.Read)
        ...
        If dt.Rows.Count > 0 Then
            ...
            cell.SetCellValue("Region Wise DD Report - " & ddlProcessMnth.SelectedItem.Text & ddlProcessYr.SelectedValue)
            cell = CType(row.GetCell(0), XSSFCell)
        ...
        End If
        Dim file_name As String = "Region_Depot_Wise_Unit_Despatch_Report" + DateString + ".xlsx"
