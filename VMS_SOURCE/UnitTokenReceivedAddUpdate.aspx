<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UnitTokenReceivedAddUpdate.aspx.vb" Inherits="UnitTokenReceivedAddUpdate" %>
                    ...
                    <table style="width: 85%;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="height: 15px; width: 100%; text-align: center;">
                                <h2 style="font-size: 14px; font-weight: bold; color: #6694e2; margin: 0px; font-family: Verdana; text-decoration: underline;">Token Requisition Received Add/Update</h2>
                            </td>
                        </tr>
                        ...
                        <tr style="text-align: left;">
                            <td>
                                ...
                                <div style="float: right">
                                    ...
                                    <span style="float: right">Full Received</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <ContentTemplate>
                                        <table border="0" style="width: 100%" cellspacing="1" class="mt">
                                            ...
                                            <tr class="tdfloat" align="left">
                                                ...
                                                <td style="background-color: #FFFFFF; height: 30px; text-align: left; font-size: 11px; font-weight: bold; font-family: Verdana; height: 15px;" class="clsTDbg" align="left">
                                                    <asp:Label ID="lblSite" Font-Names="Verdana" Font-Size="11px" runat="server" />

                                                </td>
                                            </tr>
                                            <tr class="tdfloat" align="left">
                                                <td class="style5" style="width: 50%">
                                                    <span style="color: black">Received Id :</span>
                                                </td>
                                                <td style="background-color: #FFFFFF; height: 30px; text-align: left; font-size: 11px; font-weight: bold; font-family: Verdana; height: 15px;" class="clsTDbg" align="left">
                                            ...
                                            <tr class="tdfloat" align="left">
                                                <td class="style5" style="width: 50%">
                                                    <span style="color: black">Token Vendor :</span>
                                                </td>
                                                <td style="background-color: #FFFFFF; height: 30px; text-align: left; font-size: 11px; font-weight: bold; font-family: Verdana; height: 15px;" class="clsTDbg" align="left">
                                            ...
                                            <tr class="tdfloat" align="left">
                                                ...
                                                <td style="background-color: #FFFFFF; height: 30px; text-align: left; font-size: 11px; font-weight: bold; font-family: Verdana; height: 15px;" class="clsTDbg" align="left">
                                                    <asp:DropDownList ID="ddlRequisition" Font-Names="Verdana" Font-Size="11px" runat="server" AutoPostBack="True" />
                                            ...
                                            <tr class="tdfloat" align="left">
                                                ...
                                                <td style="background-color: #FFFFFF; height: 30px; text-align: left; font-size: 11px; font-weight: bold; font-family: Verdana; height: 15px;" class="clsTDbg" align="left">
                                                    <asp:DropDownList ID="ddlDespatch" Font-Names="Verdana" Font-Size="11px" runat="server" AutoPostBack="True" />
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" Width="6%" Height="50px" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Product">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSku" runat="server" Text='<%# Bind("productId") %>'></asp:Label>
                                            ...
                                            <ItemStyle HorizontalAlign="Center" Width="8%" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Despatched Qty" ControlStyle-Width="90%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDespatchedQty" placeholder="0" Text='<%# Bind("qty") %>' runat="server"></asp:Label>
                                                            <asp:HiddenField ID="hdnDespatchedQty" Value='<%# Bind("qty") %>' runat="server" />
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Qty to be Received" ControlStyle-Width="90%">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRecieveQty" placeholder="0" Text='<%# Bind("receive_qty") %>' runat="server"></asp:TextBox>
                                                        </ItemTemplate>
