...
'Source	        : Depot_Despatches_Unitwise.aspx.vb
'Created Date	: 14-December-2011
'Created By	    : Debayan Biswas
'Version	    : R02.00.00
'Description	: Code behind for Depot_Despatches_Unitwise.aspx Page
...
Partial Class Depot_Despatches_Unitwise
...
#Region "Load Search Criteria"
    ...
    Private Sub LoadSearchCriteria()
        If Not (Session(Constant.SessionKeys.DptDsptchUntWiseSearchInfo) Is Nothing) Then
            ...
            ddlDsptchdUnit.SelectedValue = DptDsptchUntWiseSearchInfo.Depot_Despatch_Unitwise_Unit
...
#Region "Save Search Criteria"
    Public Sub SaveSearchCriteria()
        ...
        DptDsptchUntWiseSearchInfo.Depot_Despatch_Unitwise_Unit = ddlDsptchdUnit.SelectedValue
...
#Region "btnSubmit Click Event Handeling"
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        If ddlPrntOptn.SelectedValue = Constant.Common.ExcelFormat Then
            ...
            ExcelSet = DptDsptchdUntWise.GetExcelDptDsptchUntWiseRpt(ddlRegion.SelectedValue, ddlLocation.SelectedValue, ddlDsptchdUnit.SelectedValue, txtFinYear.Text.Trim, txtMonth.Text.Trim, Constant.Common.ActiveStatus)
            If (ExcelSet.Tables(0).Rows.Count > 0) Then
                ...
                FileNme = FileNme + "_" + "Depot_Despatches_Sourcewise" + "_" + Convert.ToString(Date.Today.Day) + "_" + Convert.ToString(Date.Today.Month) + "_" + Convert.ToString(Date.Today.Year)
        ...
        Else
            ...
            ReportViewer.DptDsptchdUntWiseUnit = ddlDsptchdUnit.SelectedValue
...
#Region "Function to Export Dataset to Excel"
    Protected Sub ExportToExcel(ByVal dset As DataSet, ByVal Response As HttpResponse, ByVal filename As String)
        ...
        Try
            ...
            Response.Write("<div style='text-align:center;'><b>" + "Depot Despatches-Sourcewise" + "</b></div><BR>")
