...
Partial Class ShareOf_Business_Report
...
#End Region
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Try
            ExcelSet = cls.GetBusinessSharelist(ddlLocation.SelectedValue, userInfo.userIDEntity, ddlProcessYr.SelectedValue, ddlProcessMnth.SelectedValue)
    ...
    Private Sub ExportToExcelSheet(ByVal dset As DataSet)
        Try
            ...
            Dim fs As FileStream = New FileStream(Server.MapPath(Request.ApplicationPath) & "\Templates\ShareOfBusiness_Report_Template.xlsx", FileMode.Open, FileAccess.Read)
            ...
            row = sheet.GetRow(0)
            cell = row.GetCell(0)
            cell.SetCellValue("Share Of Business Report As On - " + Format(Now, "dd-MM-yyyy").ToString)
            ...
            For i = 0 To dset.Tables(0).Rows.Count - 1
                ...
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("Despatch_Type")))
                ...
                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("ProductWiseTotalVolume")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("L1_Volume")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("L1_Achievement")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("L2_Volume")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("L2_Achievement")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("L3_Volume")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("L3_Achievement")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("Other_Volume")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToDouble(dset.Tables(0).Rows(i)("Other_Achievement")))
                cell.CellStyle = styleValue
                colIndex += 1
            ...
            End If
            Dim file_name As String = "ShareOfBusiness_Report_" & DateString & ".xlsx"
