...
'Source	        : Monthly_Unit_Despatch.aspx.vb
'Created Date	: 14-December-2011
'Created By	    : Deepak Yadav
'Version	    : R02.00.00
'Description	: Code behind for Monthly_Unit_Despatch.aspx Page

'Modified By :Deepak
'Modified On : 13/01/2012        
'Reason : Need To Add Depot Code-Name  Seperately and Sku Code in 'Product(6)-Shape(4)-Pack(6)' Format
'****************************************************************
Imports System.Data
Imports VMS.Web
Imports System.Data.SqlClient
Imports System.Data.SqlTypes
Partial Class Monthly_Unit_Despatch
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Try
            ...
            If ddlReportFormat.SelectedValue = Constant.Common.ExcelFormat Then
                ...
                ExcelSet = reportObj.GetMonthlyUnitDespatchReport(active, region, depot, ProcessYr, ProcessMnth, unit)
                If (ExcelSet.Tables(0).Rows.Count > 0) Then
                    ...
                    For i = 0 To rowcount - 1
                        ...
                        ExcelSet.Tables(0).Rows(i)("LTR") = IIf(ExcelSet.Tables(0).Rows(i)("LTR") <> 0.0, CType(ExcelSet.Tables(0).Rows(i)("LTR"), Decimal), DBNull.Value)
                        ExcelSet.Tables(0).Rows(i)("KG") = IIf(ExcelSet.Tables(0).Rows(i)("KG") <> 0.0, CType(ExcelSet.Tables(0).Rows(i)("KG"), Decimal), DBNull.Value)


                        If ExcelSet.Tables(0).Rows(i)("Approved Y/N") = "Y" Then
                            ExcelSet.Tables(0).Rows(i)("Approved Y/N") = "Yes"
                        End If
                        If (ExcelSet.Tables(0).Rows(i)("Approved Y/N") = "N" Or ExcelSet.Tables(0).Rows(i)("Approved Y/N") = "") Then
                    ...
                    FileNme = FileNme + "_" + "Challan wise Unit Despatches" + "_" + Convert.ToString(Date.Today.Day) + "_" + Convert.ToString(Date.Today.Month) + "_" + Convert.ToString(Date.Today.Year)
...
#Region "Function to Export Dataset to Excel"
    Protected Sub ExportToExcel(ByVal dset As DataSet, ByVal Response As HttpResponse, ByVal filename As String)
        ...
        'Dim processyr As String = dset.Tables(0).Rows()("")
        Try
            Response.Clear()
            Response.Charset = ""
            Response.ContentType = "application/vnd.ms-excel"
            Response.Write("<div style='text-align:center;'><b>" + "Challan wise Source Despatches" + "</b></div><BR>")
            Response.Write("<div style='text-align:right;'><b>" + "Report Date:" + Format(Date.Today, "dd/MM/yyyy") + "</b></div><BR>")
            'Response.Write("<div style='text-align:center;'><b>" + FormatDate(Date.Today) + "</b></div><BR>")
            ...
            dset.Tables(0).Columns.Remove("despd_sku_vol")
            dset.Tables(0).Columns.Remove("Depot")
            'dset.Tables(0).Columns.Remove("desph_approved_yn")
...
#End Region
    ...
    Protected Sub dg_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If (e.Row.RowType = DataControlRowType.DataRow) Then

            'If Not e.Row.Cells(22).Text = "Y" Then
            If Not e.Row.Cells(28).Text = "Yes" Then
