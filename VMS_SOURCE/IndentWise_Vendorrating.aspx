<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="IndentWise_Vendorrating.aspx.vb" Inherits="IndentWise_Vendorrating" %>
    ...
    <div class="breadcrumbs">
        <div class="leftFung">
            ...
            <div class="pageTitleWrap">
                <h3 class="pageTitle">Indent Wise Vendor Rating Report </h3>
                <p class="pageSubTitle">Vendor rating scores indent by indent</p>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlDsptchdUnit" runat="server" CssClass="form-control select2">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-3">
