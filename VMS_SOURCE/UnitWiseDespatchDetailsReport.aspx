<%@ Page Title="Unit Wise Despatches" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="UnitWiseDespatchDetailsReport.aspx.vb" Inherits="UnitWiseDespatchDetailsReport" %>
    ...
    <div class="breadcrumbs">
        <div class="leftFung">
            ...
            <div class="pageTitleWrap">
                <h3 class="pageTitle">Unit Wise Despatches</h3>
                <p class="pageSubTitle">Detailed despatch report by unit</p>
            </div>
        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                             ...
                             <%--   <a class="formCalndIcon" href="javascript:cal1.select(document.forms[0].txtFromDate,'FromDate','dd/MM/yyyy');">
                                    <img src="images/date_icon.gif" id="FromDate" alt="Calender" style="border: 0" />
                                </a>--%>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                             ...
                             <%--   <a class="formCalndIcon" href="javascript:cal1.select(document.forms[0].txtToDate,'ToDate','dd/MM/yyyy');">
                                    <img src="images/date_icon.gif" id="ToDate" alt="Calender" style="border: 0" />
                                </a>--%>
                            </div>
                        </div>
                    </div>
