<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TokenRequisitionStatusList.aspx.vb" Inherits="TokenRequisitionStatusList" %>
                                        ...
                                        <td style="width: 85%">
                                            ...
                                            <table style="width: 100%; text-align: center;" class="mt">
                                                <tr style="background-color: #E6F5FB; height: 20px;">
                                                    ...
                                                    <td style="width: 13%;">Vendor Name
                                                    </td>
                                                    <td style="width: 8%;">Requisition Id
                                                    </td>
                                                    <%-- <td style="width: 13%;">
                                                                Status
                                                            </td>--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <%--<td>
                                                                ...
                                                                <asp:DropDownList ID="ddlStatus" Font-Names="Verdana" Font-Size="11px" runat="server" AutoPostBack="false" />
                                                            </td>--%>
                                                </tr>
                                            </table>
                                            ...
                                            <asp:GridView ID="gvRequistionList" runat="server" AutoGenerateColumns="False" EmptyDataText="No records found" AllowPaging="true" PageSize="20" BorderWidth="1" CssClass="table table-hover upgradDataGrid">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Despatched Qty." ControlStyle-Width="90%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDespatchedQty" Text='<%# Bind("DespatchQty") %>' runat="server" />
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Receipt Qty." ControlStyle-Width="90%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblReceiptQty" Text='<%# Bind("TotalReceivedQty")%>' runat="server" />
                                                        </ItemTemplate>
