...
Partial Class AddUpdateSTPIndentEntry
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'btnSubmit.Attributes.Add("onclick", "return validateSKUListAdd();")
...
#Region "Populate Vendor Unit dropdown."
    ...
    Private Sub PopulateVendorUnit()
        ...
        Try
            ...
            dsVendorUnit = vndIndentMaster.GetDstnctSTPVendoratVndSkuMstr(indent_header)
...
#Region "Populate Product dropdown."
    ...
    Private Sub PopulateVendorUnitProduct()
        ...
        Try
            ...
            dsVendorUnitProduct = vndprdIndentMaster.GetDstnctSTPVendorProductListatVndSkuMstr(indent_header)
...
#Region "Populate SKU Codes gridview in case of New Indent Entry."
    ...
    Private Sub PopulateSKUCodes()
        ...
        dsProductSKUCodes = vndprdskuIndentMaster.GetSTPVendorProductSKUListsatVndSkuMstr(indent_header, updateYN)
...
#End Region
    ...
    Protected Sub gvIndentSKUList_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvIndentSKUList.RowDataBound
    ...
    Protected Sub btnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        Dim path = "~/AddUpdateSTPIndentEntry.aspx"
