...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" src="Scripts/ValidationAddUpdateSTPIndentEntry.js?time=<%= DateTime.Now.ToString("yyyy.MM.dd-HH.mm.ss.fff") %>"></script>
    ...
    <div class="breadcrumbs">
        <div class="leftFung">
            ...
            <div class="pageTitleWrap">
                ...
                <p class="pageSubTitle">Raise or revise an STP indent</p>
            </div>
        </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlVendorProduct" runat="server" CssClass="form-control select2" AutoPostBack="True">
                                </asp:DropDownList>
                            </ContentTemplate>
                            <Triggers>
