...
Public Class MonthLoadVsDespatchesClass
...
#Region "Get Report for Month Load vs Despatch Report"
    Public Function PendingDespatch_Report(ByVal active As String, ByVal region As String, ByVal depot As String, ByVal ProcessYr As String, ByVal ProcessMnth As String, ByVal unit As String, ByVal OrderBy_Depot_Sku As String) As DataSet
        ...
        PrjectList = DBFactory.GetHelper().ExecuteDataSet("[MonthLoadvsDespatch_Report]", Data.CommandType.StoredProcedure, sqlParams)
        Return PrjectList
    End Function
#End Region
End Class
