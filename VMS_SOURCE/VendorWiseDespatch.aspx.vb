...
Partial Class VendorWiseDespatch
...
#End Region
    ...
    Protected Sub btndownload_Click(sender As Object, e As EventArgs)
        Try
            ...
            ExcelSet = reportObj.GetVendorWiseDespatchReport(ddlProcessYr.SelectedValue, ddlProcessMnth.SelectedValue, userInfo.userIDEntity, ddlproductcat.SelectedValue, ddlproductcode.SelectedValue, ddlRegion.SelectedValue, ddlDepot.SelectedValue, ddlUnit.SelectedValue)
    ...
    Private Sub ExportToExcelSheet(ByVal ds As DataSet)
        ...
        Dim fs As FileStream = New FileStream(Server.MapPath(Request.ApplicationPath) & "\Templates\Vendor_Wise_Unit_Despatch_Report_Template.xlsx", FileMode.Open, FileAccess.Read)
        ...
        If dt.Rows.Count > 0 Then
            ...
            cell.SetCellValue("Source OPC Wise Report - " & ddlProcessMnth.SelectedItem.Text & ddlProcessYr.SelectedValue)
            cell = CType(row.GetCell(0), XSSFCell)
            ...
            For i = 0 To dt.Rows.Count - 1
                ...
                If Convert.ToString(dt.Rows(i)("Source")) = "GRAND TOTAL" Then
                ...
                cell = CType(row.CreateCell(Math.Min(System.Threading.Interlocked.Increment(CellIndex), CellIndex - 1)), XSSFCell)
                cell.SetCellValue(Convert.ToDecimal(dt.Rows(i)("dd_sku_vol")))
                cell.CellStyle = styleRight

                ddskuvol = ddskuvol + Convert.ToDecimal(dt.Rows(i)("dd_sku_vol"))
            ...
            PercentageDD = Math.Round((ddskuvol / (vmsSKUVol + ddskuvol) * 100), 2)
        ...
        End If
        Dim file_name As String = "Venodor_Wise_Unit_Despatch_Report" + DateString + ".xlsx"
