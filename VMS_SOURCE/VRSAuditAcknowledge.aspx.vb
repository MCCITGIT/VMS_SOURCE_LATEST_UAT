...
Partial Class VRSAuditAcknowledge
...
#Region "Populate Vendor dropdown."
    ...
    Private Sub PopulateVendor()
        ...
        Try
            ...
            ds = obj.GetVendorAuditAcknowledge(userInfo.userIDEntity, ddlQuarter.SelectedValue)
...
#End Region
    ...
    Protected Sub btnReset_Click(sender As Object, e As EventArgs) Handles btnReset.Click
        Dim path = "~/VRSAuditAcknowledge.aspx"
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        ...
        dsAudit = obj.GetAuditDetailsReport(ddlVendor.SelectedValue, ddlQuarter.SelectedValue)
    ...
    Private Sub ExportToExcelSheet(ByVal dset As DataSet)
        Try
            ...
            Dim fs As FileStream = New FileStream(Server.MapPath(Request.ApplicationPath) & "\Templates\Audit_Detail_Report.xlsx", FileMode.Open, FileAccess.Read)
            ...
            Dim sheet As XSSFSheet = templateWorkbook.GetSheet("AuditDetails")
            ...
            For i = 0 To dset.Tables(0).Rows.Count - 1
                ...
                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("currentquarter")))
                cell.CellStyle = styleCenter
                colIndex += 1
                ...
                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("ap_parameter_type")))
                cell.CellStyle = styleCenter
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("ap_parameter_name")))
                cell.CellStyle = styleCenter
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("ap_max_score")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("ah_obtained_score")))
                cell.CellStyle = styleValue
                colIndex += 1

                cell = row.CreateCell(colIndex)
                cell.SetCellValue(Convert.ToString(dset.Tables(0).Rows(i)("ah_remarks")))
                cell.CellStyle = styleCenter
                colIndex += 1
            ...
            End If
            Dim file_name As String = "Audit_details_Report" & DateString & ".xlsx"
