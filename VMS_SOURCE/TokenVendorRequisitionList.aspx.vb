...
Partial Class TokenVendorRequisitionList
...
#Region "Populate Unit"
    Private Sub PopulateUnit()
        ...
        Try
            ...
            dsUnitSet = obj.GetUnitList(userInfo.userIDEntity, "Despatched")
