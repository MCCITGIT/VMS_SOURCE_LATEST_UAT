...
#Region "Populate Product dropdown."
    ...
    Private Sub PopulateVendorUnitProduct()
        ...
        Try
            ...
            dsVendorUnitProduct = vndprdIndentMaster.GetDstnctVendorProductListatVndSkuMstr(indent_header)
...
#Region "Populate SKU Codes gridview in case of New Indent Entry."
    ...
    Private Sub PopulateSKUCodes()
        ...
        dsProductSKUCodes = vndprdskuIndentMaster.GetVendorProductSKUListsatVndSkuMstr(indent_header, updateYN)
