<%@ Page Title="Add Industrial Indent Entry" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AddUpdateIndustrialIndentEntry.aspx.vb" Inherits="AddUpdateIndustrialIndentEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" src="Scripts/ValidationAddUpdateIndustrialIndentEntry.js?time=<%= DateTime.Now.ToString("yyyy.MM.dd-HH.mm.ss.fff") %>"></script>
    ...
    <div class="breadcrumbs">
        <div class="leftFung">
            ...
            <div class="pageTitleWrap">
                <h3 class="pageTitle">Add Industrial Indent Entry</h3>
                <p class="pageSubTitle">Raise an indent for industrial products</p>
            </div>
        </div>
        ...
        <div class="card-body">
                        ...
                        <asp:GridView ID="gvIndentSKUList" runat="server" AutoGenerateColumns="False" EmptyDataText="No records found" BorderWidth="1" CssClass="table table-hover upgradDataGrid m-0">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Indent NOP" ControlStyle-Width="90%" ControlStyle-Height="90%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtNewLoad" runat="server" MaxLength="6"></asp:TextBox>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" />
            ...
            <div class="row mt-3">
                <div class="col-md-12 text-right indentEntryTotal">
                    <p>Total Ltr:
                        <asp:Label ID="lblTotLtr" runat="server"></asp:Label></p>
                    <p>Total Kg:
                        <asp:Label ID="lblTotKg" runat="server"></asp:Label></p>
                </div>
            </div>
            <div class="row">
