...
Partial Class AddUpdateIndustrialIndentEntry
...
#Region "Event Handler"
    ...
    Protected Sub btnReset_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReset.Click
        Dim path = "~/AddUpdateIndustrialIndentEntry.aspx"
...
#Region "Custom Method"
    ...
    Private Sub PopulateVendorUnit()
        ...
        Try
            ...
            dsVendorUnit = vndIndentMaster.GetDstnctVendorListatVndSkuMstr(indent_header)
    ...
    Private Sub PopulateVendorUnitProduct()
        ...
        Try
            ...
            dsVendorUnitProduct = vndprdIndentMaster.GetDistinctIndustrialVendorProductListatVndSkuMstr(indent_header)
    ...
    Private Sub PopulateSKUCodes()
        ...
        dsProductSKUCodes = vndprdskuIndentMaster.GetVendorIndustrialProductSKUListsatVndSkuMstr(indent_header, updateYN)
