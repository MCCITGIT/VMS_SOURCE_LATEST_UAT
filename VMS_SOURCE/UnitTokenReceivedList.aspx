<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UnitTokenReceivedList.aspx.vb" Inherits="UnitTokenReceivedList" %>
                    ...
                    <table style="width: 85%;" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="height: 15px; width: 100%; text-align: center;">
                                <h2 style="font-size: 14px; font-weight: bold; color: #6694e2; margin: 0px; font-family: Verdana; text-decoration: underline;">Token Despatches List For Receive</h2>
                            </td>
                        </tr>
                        ...
                        <tr style="text-align: left;">
                            <td>
                                ...
                                <div style="float: right">
                                    ...
                                    <span style="float: right; font-size: 11px; font-family: tahoma;">Receive Complete</span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="width: 85%">
                                            ...
                                            <table style="width: 100%; text-align: center;" class="mt">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&nbsp;<asp:DropDownList ID="ddlStatus" Font-Names="Verdana" Font-Size="11px" runat="server">
